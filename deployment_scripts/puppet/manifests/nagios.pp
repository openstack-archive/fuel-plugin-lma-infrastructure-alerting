...
if $plugin['node_name'] == hiera('user_node_name') {
  ...
  class { 'lma_infra_alerting::nagios::hosts':
    ...
    #hostgroups => {'compute' => {'properties' => {'members' => ['node-15']}},
    #               'controller' => {'properties' => {'members' => ['node-12']}},
    #               'cinder' => {'properties' => {'members' => ['node-15']}},
    #               'base-os' => {'properties' => {'members' => ['node-13', 'node-14']}}}
