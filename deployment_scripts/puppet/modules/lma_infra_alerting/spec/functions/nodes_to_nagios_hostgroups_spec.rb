...
describe 'nodes_to_nagios_hostgroups' do
    ...
    describe 'with empty' do
        it { should run.with_params(all_nodes, 'name', 'role', role_to_cluster).and_return(
            {"influxdb_grafana"=>{
                "properties"=>{"members"=>"node-1"}},
            "infrastructure_alerting"=>{
                "properties"=>{"members"=>"node-1"}},
            "primary-controller"=>{
                "properties"=>{"members"=>"node-3"}},
            "elasticsearch_kibana"=>{
                "properties"=>{"members"=>"node-4"}},
            "cinder"=>{
                "properties"=>{"members"=>"node-2"}},
